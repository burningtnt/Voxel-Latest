...
public class ModInjector {
    ...
    private static HashMap<String, List<EntrypointMetadata>> getEntryPointMetaDataMap() throws InvocationTargetException, InstantiationException, IllegalAccessException, NoSuchMethodException, ClassNotFoundException {
        ...
        Object entryPointMetaDataImplObject = entryPointMetaDataConstructor.newInstance("client", "com.mamiyaotaru.voxelmap.fabricmod.FabricModVoxelMap");
    ...
    public static void run() {
        try {
            ...
            Object v1ModMetadataObject = v1ModMetadataConstructor.newInstance(
                    ModInfoUtil.VOXEL_MAP, new StringVersion(String.format("1.10.15+%s", ModInfoUtil.SELF)), new ArrayList<String>(), ModEnvironment.CLIENT, entryPointMetaDataMap, new ArrayList<NestedJarEntry>(),
